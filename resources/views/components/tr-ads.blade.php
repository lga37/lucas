...
@if ($this->showColumn('cidade'))
    ...
    <td class="px-0 py-0">
        @if ($ad->preco1 > 0)
            <div class="flex flex-col">
                <span class="text-center text-green-500 text-xl font-bold">{{ kmbt($ad->preco1) }}</span>
    ...
    <td class="px-0 py-0">
        @if ($ad->preco2 > 0)
            <div class="flex flex-col">
                <span class="text-center text-green-900 text-xl font-bold">{{ kmbt($ad->preco2) }}</span>

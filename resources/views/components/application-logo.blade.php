<span class="flex items-center space-x-1">
  <span class="flex items-center text-4xl tracking-tight antialiased font-sans font-extrabold">
      ...
      class="hover:rotate-6 transition-transform duration-300">
      <rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#22c55e"></rect>
      <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path>
      <path d="M3.472,16l12.528,8,12.528-8-12.528-8L3.472,16Z" fill="#facc15"></path>
      <circle cx="16" cy="16" r="5" fill="#0f172a"></circle>
